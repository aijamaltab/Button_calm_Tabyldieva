package com.example.button_calm_tabyldieva;
...
public class MainActivity extends AppCompatActivity {
        ...
        btnGenerate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otvetInt > 0) {
                    ...
                    Toast.makeText(MainActivity.this, "Нажми Generate еще раз", Toast.LENGTH_SHORT).show();
    ...
    private void printAnswer() {
        lotty_sun.setVisibility(View.GONE);
        lotty_one.setVisibility(View.GONE);
        lotty_two.setVisibility(View.GONE);

        if (otvetInt >= 48 && otvetInt <= 65) {
            tvMainAnswer.setText("Мы рады, что ты - почти оптимист!");
            lotty_two.setVisibility(View.VISIBLE);
        } else if (otvetInt > 65 && otvetInt <= 100) {
            tvMainAnswer.setText("Супер! Отлично, я рад за тебя!");
            lotty_one.setVisibility(View.VISIBLE);
        } else if (otvetInt >= 1 && otvetInt < 48) {
            tvMainAnswer.setText("Не переживай! Все будет хорошо!");
